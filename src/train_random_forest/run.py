...
def go(args):
    ...
    # YOUR CODE HERE
    ######################################
    export_path_temp = export_model(sk_pipe, X_val, "random_forest_dir")
    export_path = export_path_temp.name
    ...
    # YOUR CODE HERE
    ######################################
    upload_model(args.output_artifact, export_path, run)
    export_path_temp.cleanup()
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    steps=[
        ...
        ("random_forest", random_Forest)     # prediction model
    ]
)
...
def upload_model(export_artifact, export_path, run):
